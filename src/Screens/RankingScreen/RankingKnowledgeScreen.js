...
const RankingKnowledgeScreen = () => {
  ...
  return (
    <UserBackground noPadding={true}>
      <ScreenTitle title={i18n.t("RNK_Ranking_knowledge")} withBack={true}/>
...
export default RankingKnowledgeScreen;
